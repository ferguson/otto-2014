    ...
    */
    ...
    $.fn.cmd = function(options) {
        ...
        function paste() {
            ...
            self.oneTime(25, function() {
														 self.insert(clip.val());
														 clip.blur().val('');
         $('#chatlog').focus();  // a horrible hack specific to my page -jon FIXME
												 });
        }
                    ...
                    if (e.shiftKey) { // CTRL+SHIFT+??
                        ...
                        if (e.which == 65) {
                            ...
                            return true;
														...
														return true; /* pass all other ctrl and meta keys back to the browser */
												}
                    }
                } else {
                    return true;
        ...
        var object;
        if (options.elementtobind) {
						object = options.elementtobind;
				}
        ...
        // characters
				$(object).focus(function(e) {
						self.find('.cursor').addClass('inverted');
				    self.everyTime(500, 'blink', blink);
				});
