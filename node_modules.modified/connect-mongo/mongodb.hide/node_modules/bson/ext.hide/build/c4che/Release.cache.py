...
CPPPATH_NODE = '/usr/local/otto/include/node'
CPPPATH_ST = '-I%s'
CXX = ['/usr/bin/g++']
CXXDEFINES_ST = '-D%s'
...
LIBDIR = '/Users/jon/.node_libraries'
LIBPATH_NODE = '/usr/local/otto/lib'
LIBPATH_ST = '-L%s'
LIB_ST = '-l%s'
LINKFLAGS_MACBUNDLE = ['-bundle', '-undefined', 'dynamic_lookup']
LINK_CXX = ['/usr/bin/g++']
NODE_PATH = '/Users/jon/.node_libraries'
PREFIX = '/usr/local'
PREFIX_NODE = '/usr/local/otto'
